...
export class GenderRepository {
    ...
    private async triggerEvent(data: GenderEntityEvent | GenderUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-employees-EmployeesSettings-Gender", ["trigger"]);
        ...
        producer.topic("codbex-employees-EmployeesSettings-Gender").send(JSON.stringify(data));
    }
}
