...
export class MartialStatusRepository {
    ...
    private async triggerEvent(data: MartialStatusEntityEvent | MartialStatusUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-employees-EmployeesSettings-MartialStatus", ["trigger"]);
        ...
        producer.topic("codbex-employees-EmployeesSettings-MartialStatus").send(JSON.stringify(data));
    }
}
