...
export class GenderRepository {
    ...
    private async triggerEvent(data: GenderEntityEvent | GenderUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-employees-entities-Gender", ["trigger"]);
        ...
        producer.topic("codbex-employees-entities-Gender").send(JSON.stringify(data));
    }
}
