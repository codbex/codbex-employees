...
export class ContactRepository {
    ...
    private async triggerEvent(data: ContactEntityEvent | ContactUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-employees-entities-Contact", ["trigger"]);
        ...
        producer.topic("codbex-employees-entities-Contact").send(JSON.stringify(data));
    }
}
