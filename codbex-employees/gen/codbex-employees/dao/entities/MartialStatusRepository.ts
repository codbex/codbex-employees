...
export class MartialStatusRepository {
    ...
    private async triggerEvent(data: MartialStatusEntityEvent | MartialStatusUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-employees-entities-MartialStatus", ["trigger"]);
        ...
        producer.topic("codbex-employees-entities-MartialStatus").send(JSON.stringify(data));
    }
}
