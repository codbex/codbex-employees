...
export class JobDetailsRepository {
    ...
    private async triggerEvent(data: JobDetailsEntityEvent | JobDetailsUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-employees-Employees-JobDetails", ["trigger"]);
        ...
        producer.topic("codbex-employees-Employees-JobDetails").send(JSON.stringify(data));
    }
}
