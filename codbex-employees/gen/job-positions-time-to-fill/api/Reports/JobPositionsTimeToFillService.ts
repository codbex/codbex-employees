...
import { JobPositionsTimeToFillRepository, JobPositionsTimeToFillFilter, JobPositionsTimeToFillPaginatedFilter } from "../../dao/Reports/JobPositionsTimeToFillRepository";
...
class JobPositionsTimeToFillService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-employees.Report.JobPositionsTimeToFillReadOnly"))) {
